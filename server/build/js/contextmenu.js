...
Raphael.el.style = function (state, style, aniOptions) {
  ...
  if (aniOptions) {
    this.animate(Raphael.styles[this.type][style][state], aniOptions.duration, aniOptions.easing, function () {
        ...
        $(this).mousedown(function (e) {
          ...
          $(this).mouseup(function (e) {
            ...
            if (e.button == 2) {
              ...
              $m.css({ top: y, left: x }).fadeIn(o.fadeIn).find('A').mouseover(function () {
