...
function estimate_time_zone(longt) {
  ...
  if (count === 9 || count === 17 || count === 19 || count === 22 || count === 27) count++;else if (count === 21) count += 2;
  // console.log("c ", count);
  return count;
}
...
function generate_new_task() {
  ...
  // ====================================================================================
  label = document.createElement("b");
  label.innerHTML = "\xA0<br>Timezone: ";
  ...
  // ====================================================================================
  label = document.createElement("b");
  label.innerHTML = "\xA0<br>Weather: ";
  ...
  var t = document.createTextNode("\xA0\xA0submit\xA0\xA0");
