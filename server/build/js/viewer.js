  ...
  $.fn.viewer = function (spath, display, model_type) {
    ...
    function init() {
      ...
      if (display) {
        ...
        if (has_b1) btn_group.appendChild(b1);
        if (has_b2) btn_group.appendChild(b2);
        if (has_b3) btn_group.appendChild(b3);
          ...
          // get the normals for each vertex
            ...
            // adding a new face
                ...
                if (obj_format == 'basic') {
                  ...
                  geometries[geometries.length - 1].faces.push(new THREE.Face3(temp_vertex_1 - 1, temp_vertex_2 - 1, temp_vertex_3 - 1));
                  ...
                  */
                  ...
                  geometries[geometries.length - 1].faceVertexUvs[0].push([new THREE.Vector2(vt[temp_vertex_1[0] - 1][1], vt[temp_vertex_1[0] - 1][0]), new THREE.Vector2(vt[temp_vertex_2[0] - 1][1], vt[temp_vertex_2[0] - 1][0]), new THREE.Vector2(vt[temp_vertex_3[0] - 1][1], vt[temp_vertex_3[0] - 1][0])]);
                }
              }
    ...
    return {
      toggle: function toggle() {
        if (ceiling.side == THREE.FrontSide) ceiling.side = THREE.DoubleSide;else ceiling.side = THREE.FrontSide;
      }
    };
  };
})(jQuery);